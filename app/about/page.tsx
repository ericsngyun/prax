  ...
  return (
    <main className="min-h-screen pt-20 md:pt-24">
      ...
      <section className="section-padding bg-prax-black">
        <div className="container-prax text-center max-w-5xl mx-auto">
          <h1 className="text-serif-display md:text-serif-hero text-prax-white mb-8">
            Built on Craft, Not Hype
          </h1>
          <p className="text-body-lg md:text-h4 text-prax-stone leading-relaxed max-w-3xl mx-auto">
            PRAX was founded to raise the standard of men's haircutting—emphasizing discipline, precision, and education over speed or volume.
          </p>
        </div>
      </section>
      ...
      <StudioSpaceSection
        ...
        images={[
          {
            src: '',
            alt: 'Studio interior - main floor',
            caption: 'The main cutting floor',
          },
          {
            src: '',
            alt: 'Individual cutting station',
            caption: 'Each station is designed for focus',
          },
          {
            src: '',
            alt: 'Tool detail shot',
            caption: 'Tools selected for precision',
          },
          {
            src: '',
            alt: 'Product shelf',
            caption: 'Curated product selection',
          },
          {
            src: '',
            alt: 'Waiting area',
            caption: 'Minimal aesthetic throughout',
          },
          {
            src: '',
            alt: 'Studio exterior',
            caption: 'Located in Los Angeles',
          },
        ]}
      />
      ...
      <section className="section-padding bg-prax-black">
        <div className="container-prax text-center max-w-4xl mx-auto">
          <h2 className="text-serif-h1 text-prax-white mb-12">
            The PRAX Standard
          </h2>
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 pt-8">
              <div className="space-y-2">
                <div className="text-h3 text-prax-bone">Precision</div>
                <div className="text-body text-prax-silver">
                  Intention in every cut
                </div>
              </div>
              <div className="space-y-2">
                <div className="text-h3 text-prax-bone">Consistency</div>
                <div className="text-body text-prax-silver">
                  Reliable results, every time
                </div>
              </div>
              <div className="space-y-2">
                <div className="text-h3 text-prax-bone">Education</div>
                <div className="text-body text-prax-silver">
